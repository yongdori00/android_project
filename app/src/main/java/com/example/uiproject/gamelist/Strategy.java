...
public class Strategy extends Fragment implements View.OnClickListener{

    ImageView bluemarble;

    String valueTheme = "strategy";
    String valueName;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bluemarble = view.findViewById(R.id.bluemarble);
        bluemarble.setOnClickListener(this);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.bluemarble:
                valueName = "bluemarble";
                break;
        }
        getInfo();
